...
#SBATCH --job-name=busco_reps_corrected
...
FASTA=/mnt/project/FjellheimLab/martpali/AnnualPerennial/nf-denovoslim/BMED/representatives/representatives_corrected.fasta
...
apptainer exec \
    ...
    busco \
        ...
        -l "$LINEAGE" \
        -m transcriptome \
        -o busco_representatives_corrected \
        -c "$CPUS"
